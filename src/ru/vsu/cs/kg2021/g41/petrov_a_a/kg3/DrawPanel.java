...
import ru.vsu.cs.kg2021.g41.petrov_a_a.kg3.DrawObject.Drawing;
import ru.vsu.cs.kg2021.g41.petrov_a_a.kg3.DrawObject.Line;
import ru.vsu.cs.kg2021.g41.petrov_a_a.kg3.DrawObject.Text;
...
public class DrawPanel extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public DrawPanel() {
        ...
        xAxis = new Line(new RealPoint(-1, 0), new RealPoint(1, 0));
    ...
    private void drawAxisScaleX(Graphics2D graphics2D) {
        ...
        secondLinePointY = firstLinePointY - screenConverter.getRealHeight();
    ...
    private void drawAxisScaleY(Graphics2D graphics2D) {
        ...
        secondLinePointX = firstLinePointX + screenConverter.getRealWidth();
    ...
    private void drawAxisScales(Graphics2D graphics2D) {
        drawAxisScaleXs(graphics2D);
        drawAxisScaleYs(graphics2D);
    }

    private void drawAxisScaleXs(Graphics2D graphics2D) {
        int leftRealBound = (int) screenConverter.getStartX();
        int rightRealBound = (int) Math.ceil(screenConverter.getStartX() + screenConverter.getRealWidth());
    ...
    private void drawAxisScaleYs(Graphics2D graphics2D) {
        int upRealBound = (int) Math.ceil(screenConverter.getStartY());
        int downRealBound = (int) (screenConverter.getStartY() - screenConverter.getRealHeight());
